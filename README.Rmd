...
This is a basic example how to use CPU_toolkit(ComprehensivePipelineUtils):
...
* Each column in the dataframe is a case sample and each row is a mRNA (feature).
...
* You can use the data get from function `read_tcga_xena` to get tumor data.
